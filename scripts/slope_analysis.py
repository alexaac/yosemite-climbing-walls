...
# ---------------------------------------------------------------------------
# slope_analysis.py
# Created on: 2020-01-17 19:24:06.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: slope_analysis <yose_valley_tiles_rst05> <Slope_Raster> <v_slope_min_value> <v_area_value> <Slope_Filtered> <Pos_Climbing_Areas> <Pos_Climbing_Buffer> 
# Description: 
# ---------------------------------------------------------------------------
...
if Slope_Raster == '#' or not Slope_Raster:
    Slope_Raster = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\results.gdb\\Slope" # provide a default value if unspecified
...
if Slope_Filtered == '#' or not Slope_Filtered:
    Slope_Filtered = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\results.gdb\\Slope_Filtered" # provide a default value if unspecified

Pos_Climbing_Areas = arcpy.GetParameterAsText(5)
if Pos_Climbing_Areas == '#' or not Pos_Climbing_Areas:
    Pos_Climbing_Areas = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\results.gdb\\Pos_Climbing_Areas" # provide a default value if unspecified

Pos_Climbing_Buffer = arcpy.GetParameterAsText(6)
if Pos_Climbing_Buffer == '#' or not Pos_Climbing_Buffer:
    Pos_Climbing_Buffer = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Pos_Climbing_Buffer" # provide a default value if unspecified

# Local variables:
Input_true_raster_or_constant_value__6_ = "1"
Slope_Filtered_1 = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Slope_Filtered_1"
Expand_Slope = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Expand_Slope"
RegionG_Expand = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\RegionG_Expand"
ZonalGe_RegionG = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\ZonalGe_RegionG"
Int_ZonalGe = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Int_ZonalGe"
...
Int_Con_Extr__2_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Int_Con_Extr"
Boundary_Extr__2_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Boundary_Extr"
Majorit_Boundary__2_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Majorit_Boundary"
Input_true_raster_or_constant_value__3_ = "1"
Con_Majorit_1 = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Con_Majorit_1"
RegionG_Con_2__3_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\RegionG_Con_1"
Extract_Regi2__3_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Extract_Regi1"
ZonalGe_Extr2__3_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\ZonalGe_Extr1"
Input_true_raster_or_constant_value__4_ = "1"
Con_ZonalGe_1__3_ = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Con_ZonalGe_1"
Pos_Climbing_Zones = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\results.gdb\\Pos_Climbing_Zones"
Output_direction_raster = ""
temp = ""
Input_true_raster_or_constant_value__2_ = "1"
Con_Pos_Clim1 = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Con_Pos_Clim1"
EucDist_Fina1 = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\EucDist_Pos_1"
Input_true_raster_or_constant_value = "1"
Con_EucDist_1 = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Con_EucDist_1"
rastercalc = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\rastercalc"
Input_true_raster_or_constant_value__5_ = "1"
Con_rasterca1 = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Con_rasterca1"
Final_Slope_Poly = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Final_Slope_Poly"
Slope_Poly = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Final_Slope_PolyB"
Final_Slope_PolyB_Dissolve = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Final_Slope_PolyB_Dissolve"
Final_Sope_PolyB_BufferI = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Final_Sope_PolyB_BufferI"
Pos_Climbing_B = "D:\\gis\\GIS_Coursera\\5. Geospatial Analysis Project\\Work\\data\\scratch.gdb\\Pos_Climbing_B"
...
arcpy.gp.ZonalGeometry_sa(RegionG_Expand, "VALUE", ZonalGe_RegionG, "AREA", "0.5")
...
arcpy.gp.ZonalGeometry_sa(Extract_Regi2__3_, "VALUE", ZonalGe_Extr2__3_, "AREA", "0.5")
...
arcpy.RasterToPolygon_conversion(Con_rasterca1, Final_Slope_Poly, "NO_SIMPLIFY", "VALUE", "SINGLE_OUTER_PART", "")
...
arcpy.EliminatePolygonPart_management(Final_Slope_Poly, Slope_Poly, "AREA", "2000 SquareMeters", "0", "CONTAINED_ONLY")
...
# Process: Buffer (3)
arcpy.Buffer_analysis(Final_Slope_PolyB_Dissolve, Final_Sope_PolyB_BufferI, "-12 Meters", "FULL", "ROUND", "ALL", "", "PLANAR")

# Process: Polygon to Raster
arcpy.PolygonToRaster_conversion(Final_Sope_PolyB_BufferI, "OBJECTID", Pos_Climbing_B, "CELL_CENTER", "NONE", "0.5")

# Process: Con (10)
arcpy.gp.Con_sa(Pos_Climbing_B, Input_true_raster_or_constant_value__7_, Pos_Climbing_Buffer, "", "")

# Process: Con (9)
arcpy.gp.Con_sa(Pos_Climbing_Buffer, Slope_Raster, Pos_Climbing_Areas, "", "")
